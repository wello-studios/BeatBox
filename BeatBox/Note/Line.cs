...
namespace BeatBox.Note
{
    public class Line : MonoBehaviour
    {
        ...
        public List<double> currLineNoteDownTicks;
        public List<double> currLineNoteUpTicks;
        public List<double> currLineNoteSLTicks;
        public List<double> currLineNoteSRTicks;
